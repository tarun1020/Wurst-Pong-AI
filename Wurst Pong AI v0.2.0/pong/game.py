...
class Game:
    ...
    def loop(self):
        ...
        if random.randint(1, 1000) == 1:
            print("Ugh im getting tired of this game.")
        ...
        if self.ball.x < 0:
            self.ball.reset()
            self.right_score += 1
            choices = ["YES!!! I am the best Pong AI to ever be coded!!!",
                       "HAHAHA Look whose laughing now!!!"]
            print(random.choice(choices))
        elif self.ball.x > self.window_width:
            self.ball.reset()
            self.left_score += 1
            choices2 = ["It was a lucky shot I guess",
